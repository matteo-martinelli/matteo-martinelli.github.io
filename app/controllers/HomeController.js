...
export class HomeController {
    ...
    async init() {
        ...
        this.styleElement.href = '/css/pages/index-style.css';
        document.head.appendChild(this.styleElement);
        
        // Getting the content and injecting it
        const appContainer = document.querySelector('#app');
        if (appContainer) {
            appContainer.innerHTML = await this.view.getHtml('/templates/home-top-content.html');  
            appContainer.insertAdjacentHTML('afterend', await this.view.getHtml('/templates/spacer.html'));  
        }
        
        const layoutNavbarContainer = document.querySelector('#landing-page-menu');
        if (layoutNavbarContainer) {
            layoutNavbarContainer.innerHTML = await this.view.getHtml('/templates/low-navbar.html');
        }
    }
